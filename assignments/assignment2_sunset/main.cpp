...
int main() {
	...
	//std::string vertexShaderSource = ab::loadShaderSourceFromFile("assets/vertexShader.vert");
	//std::string fragmentShaderSource = ab::loadShaderSourceFromFile("assets/fragmentShader.frag");
